  ...
  - block: markdown
    content:
      ...
      text: |
        ...
        <h3 class="healim-book-title">불안장애·자율신경실조증·공황장애 극복지침서</h3>
        ...
        var defaultReviewsData = [
          ...
          },
          {
            ...
            "content": "회사 프로젝트 발표 도중 갑자기 눈앞이 하얘지면서 바닥으로 주저앉은 뒤로 외출 자체가 공포였습니다. 대학병원 신경과와 이비인후과에서 이석증, 전정신경염, 뇌 MRI 검사까지 다 받았지만 아무 이상이 없다며 신경성이라는 말만 되풀이했습니다. 서 있기만 해도 다리에 피가 쏠리고 뇌로 피가 안 통하는 느낌에 하루하루 퇴사를 심각하게 고민했습니다.\n\n그러다 자율신경실조증을 중점 치료하는 해아림한의원을 알게 되었습니다. 원장님께서 압수용체 반사 기능 저하와 교감-부교감 불균형 상태를 꼼꼼히 진단해 주신 후, 기립성 혈류를 끌어올리는 맞춤 한약과 경추 신경절 약침 치료를 정성껏 병행해 주셨습니다. 복용 한 달 차부터 일어설 때 핑 도는 암전 증상이 눈에 띄게 줄었고, 3개월 치료를 마친 지금은 장시간 서서 프레젠테이션을 해도 머리가 맑고 중심이 단단하게 잡힙니다. 잃어버렸던 일상과 직장 생활의 자신감을 되찾아주셔서 원장님께 진심으로 감사드립니다.",
            "hasTreatment": true,
            "treatmentType": "한약 + 약침",
            "isCustom": false,
            "isCanonical": true
          ...
          },
          {
            ...
            "title": "새벽마다 심장이 터질 듯 뛰며 잠에서 깨던 야간 빈맥, 자율신경 맞춤 탕약 복용 2개월 만에 평온을 찾았습니다",
          ...
          },
          {
            ...
            "content": "새벽 2~3시만 되면 심장이 분당 130회 이상 쿵쾅거리며 잠에서 깨어났습니다. 가슴이 조여오고 숨이 턱 끝까지 막혀 이러다 죽는 게 아닐까 하는 공포에 응급실을 수도 없이 들락거렸습니다. 24시간 홀터 심전도 검사도 정상이어서 가족들조차 제 예민함 탓으로 돌려 외롭고 억울한 눈물만 흘렸습니다.\n\n해아림한의원에서 자율신경 검사를 받고 교감신경이 24시간 비상 경보 상태로 과열되어 있다는 설명을 들었을 때 비로소 제 증상의 실체를 이해하고 큰 위로를 받았습니다. 원장님께서 제 몸의 속도에 맞춰 차근차근 신경계를 안정시켜 주셨고, 치료를 진행하면서 새벽에 심장이 요동치며 깨는 횟수가 기적처럼 줄어들었습니다. 이제는 저녁에 누우면 아침까지 깨지 않고 깊은 단잠을 잡니다. 온 가족이 편안해졌고 제 삶의 평온을 되찾아주신 해아림에 깊이 감사드립니다.",
            "hasTreatment": false,
            "treatmentType": null,
            "isCustom": false,
            "isCanonical": true
          ...
          },
          {
            ...
            "content": "취업 준비와 시험 스트레스가 겹치면서 조금만 신경을 쓰면 체하고 명치가 돌덩이처럼 딱딱하게 굳었습니다. 위내시경은 깨끗한데 물 한 모금만 마셔도 헛구역질이 나고 몸무게가 8kg이나 빠져 뼈만 앙상하게 남았습니다. 소화제와 제산제를 달고 살아도 속 쓰림과 메스꺼움은 가시지 않았습니다.\n\n위장이 뇌의 미주신경과 직접 연결되어 있다는 사실을 해아림에서 처음 배웠습니다. 원장님의 진솔한 상담과 자율신경 케어를 받으면서 딱딱하게 굳어 있던 명치 통증이 부드럽게 풀리기 시작했고, 멈춰 있던 소화관이 다시 자연스럽게 움직이는 것을 체감했습니다. 지금은 친구들과 맛집도 찾아다니고 가족들과 함께 일반식을 맛있게 소화할 수 있을 정도로 건강해졌습니다. 새로운 에너지를 되찾아주셔서 감사드립니다.",
            "hasTreatment": false,
            "treatmentType": null,
            "isCustom": false,
            "isCanonical": true
          ...
          },
          {
            ...
            "content": "자고 일어나도 뇌에 기름이 낀 것처럼 멍하고 집중이 전혀 되지 않았습니다. 학생들의 질문에 바로 대답이 나오지 않고 단어가 떠오르지 않아 수업 진행이 불가능할 정도였습니다. 번아웃과 만성 피로로 휴직까지 결심하고 절망적인 나날을 보냈습니다.\n\n해아림한의원에서 뇌파 검사와 자율신경 검사를 진행한 뒤 뇌간 순환을 돕는 맞춤 한약과 경추-두개골 긴장을 부드럽게 이완시키는 두개천골요법(CST)을 꾸준히 받았습니다. 치료 4주 차부터 머리를 무겁게 짓누르던 두중감이 걷히더니 시야가 선명해졌습니다. 3개월 후에는 복합적인 사고와 기억력이 예전 상태로 충실히 돌아와 무사히 교단으로 복직할 수 있었습니다. 맑은 머리로 아이들을 마주하는 매일이 행복합니다.",
            "hasTreatment": true,
          ...
          },
          {
            ...
            "title": "일어설 때마다 눈앞이 캄캄해지고 심장이 130회까지 뛰던 기립성 빈맥증후군, 안정적으로 회복 판정 받았습니다",
          ...
          },
          {
            ...
            "content": "얼굴과 머리로는 열이 훅 치밀어 올라 에어컨 바람을 쐬어야 하는데, 손과 발은 얼음장처럼 시려서 양말을 두 켤레 신고 지냈습니다. 체온 조절이 전혀 되지 않으니 감기 몸살 같은 오한과 열감이 번갈아 찾아와 여름에도 겨울에도 괴로웠습니다.\n\n해아림한의원 자율신경 클리닉에서 신경계 순환 불통으로 인한 상열하한 진단을 받고 치료를 시작했습니다. 흩어져 있던 신경 신호와 혈류 균형이 서서히 제자리를 잡으면서, 머리로 솟구치던 화끈거림이 사라지고 발끝까지 따뜻한 온기가 돌기 시작했습니다. 체온이 안정되니 덩달아 두통과 만성 피로까지 함께 씻은 듯 나았습니다. 사계절 내내 온몸이 편안해져 이제는 일에 온전히 몰입할 수 있습니다. 늘 정성으로 살펴주신 의료진분들께 감사드립니다.",
            "hasTreatment": false,
            "treatmentType": null,
            "isCustom": false,
            "isCanonical": true
          ...
          },
          {
            ...
            "content": "출퇴근길 지하철이나 차 안에서 숨을 깊이 들이쉬지 못하고 얕은 숨만 헐떡이며 질식할 것 같은 호흡곤란이 시작되었습니다. 신경안정제를 복용해도 약기운이 떨어지면 다시 숨이 차올라 대중교통 이용을 아예 포기했었습니다. 해아림한의원에서 흉부의 억압된 흉곽 호흡근을 이완시키고 과항진된 횡격막 자율신경을 안정시키는 승기탕 가감방과 자율신경 바이오피드백 호흡 훈련을 받았습니다. 치료 8주 차부터 가슴이 확 트이면서 숨이 깊게 내려앉았고, 현재는 지하철 만원 전철도 편안하게 타고 다닙니다.",
          ...
          },
          {
            ...
            "content": "목구멍에 솜뭉치나 가래가 딱 붙어 있는 느낌에 24시간 헛기침을 뱉어내느라 목이 헐었습니다. 이비인후과 내시경과 역류성 식도염 약을 수개월 복용해도 호전이 없어 말할 때마다 숨이 차고 가슴이 답답했습니다.\n\n해아림한의원에 내원하여 교감신경 항진으로 인후부 근육이 경련성 긴장을 일으키는 자율신경성 매핵기라는 것을 알게 되었습니다. 원장님께서 뭉친 기운을 풀어주는 맞춤 체질 한약만으로 처방을 구성해 주셨는데, 복용 3주 차부터 목에 걸려 있던 이물감이 절반 이하로 줄어들더니 두 달 차에는 완전히 사라졌습니다. 헛기침 없이 편안하게 호흡하고 사람들과 대화할 수 있게 되어 살 것 같습니다. 세심한 진료에 진심으로 감사드립니다.",
            "hasTreatment": true,
          ...
          },
          {
            ...
            "content": "아침 출근길 지하철 문이 닫히는 순간 갑자기 배가 쥐어짜듯 아프고 식은땀이 흐르며 급박하게 화장실을 찾게 되는 과민성 대장 증상으로 고통받았습니다. 중간 역에 내려 화장실을 전전하느라 지각하기 일쑤였고, 장거리 버스나 중요한 미팅은 상상도 못 했습니다.\n\n해아림한의원에서 뇌와 장이 자율신경으로 연결되어 긴장할 때마다 장이 과민 수축한다는 설명을 듣고 깊이 공감했습니다. 치료를 받으면서 장의 예민도가 점차 둔감해지고 복통 빈도가 줄어들었습니다. 지금은 출근길에 아무 불안 없이 음악을 들으며 여유롭게 이동할 수 있고, 먼 지방 출장도 편안하게 다녀옵니다. 제게 일상의 자유와 평온함을 돌려주셔서 감사합니다.",
            "hasTreatment": false,
            "treatmentType": null,
            "isCustom": false,
            "isCanonical": true
          },
          {
            ...
            "content": "겨울에도 얼굴과 머리로 화염방사기를 쏘는 것처럼 열이 훅 뻗치는데, 반대로 발끝은 시려 잠을 잘 수가 없었습니다. 갱년기 호르몬제와 혈관확장제를 복용해도 상체 열은 식지 않고 두통만 심해졌습니다. 해아림 원장님께서 자율신경 말초 혈관 조절 장애로 인한 '수승화강(水升火降) 실조'로 진단해 주셨습니다. 상체의 허열을 서늘하게 내리고 하초의 양기를 따뜻하게 덥혀주는 맞춤 한약과 배수혈 약침을 꾸준히 치료받았더니, 2개월 만에 얼굴의 화끈거림이 사라지고 발끝까지 따뜻한 혈액 순환이 이루어졌습니다.",
            "author": "50대 주부 강OO 님",
            "date": "2023.11.08",
            "views": 1930,
            "image": "/images/reviews/review_5.jpg"
          ...
          },
          {
            ...
            "content": "가슴에 무거운 돌덩이를 얹어 놓은 것처럼 숨이 끝까지 들어가지 않아 하루 종일 억지로 큰 하품을 하거나 가슴을 쳐야 했습니다. 폐와 심장 검사는 정상인데 공기가 부족한 느낌에 질식할 것 같은 불안감이 엄습했습니다. 자다가도 숨이 차서 깨어나 창문을 열고 심호흡을 해야만 했습니다.\n\n해아림의 자율신경 조절 치료를 받으면서 흉곽 주변 근육의 긴장이 부드럽게 이완되고, 가슴 한가운데를 짓누르던 답답함이 시원하게 풀렸습니다. 이제는 의식하지 않아도 아랫배까지 깊고 편안한 복식 호흡이 자연스럽게 이루어집니다. 숨 쉬는 것이 이렇게 편안하고 감사한 일인지 새삼 깨닫게 되었습니다. 늘 온화하게 격려해 주신 원장님 감사드립니다.",
            "hasTreatment": false,
            "treatmentType": null,
            "isCustom": false,
            "isCanonical": true
          ...
          },
          {
            ...
            "title": "조금만 긴장하거나 외출만 하면 화장실로 달려가던 신경성 과민대장, 장 자율신경 회복으로 안정",
          ...
          },
          {
            ...
            "views": 2317,
            "image": "/images/reviews/review_5.jpg",
            "title": "귓속 삐 소리와 구름 위를 걷는 듯한 어지럼증, 해아림에서 안정적으로 회복했습니다",
            "content": "오른쪽 귀에서 밤낮없이 삐- 하는 고주파 이명이 들리고, 걸을 때마다 스펀지 위나 구름 위를 걷는 것처럼 휘청거려 넘어질 뻔한 적이 한두 번이 아니었습니다. 이비인후과에서는 평생 적응하며 살아야 한다고 해서 눈앞이 캄캄했습니다.\n\n지푸라기라도 잡는 심정으로 해아림한의원에 내원하여 자율신경계 순환 치료를 받았습니다. 서서히 귀 주변의 미세 혈류가 개선되고 뇌압이 안정되면서, 귓속을 울리던 날카로운 소리가 희미해지더니 3개월 만에 일상에서 거의 의식하지 못할 정도로 호전되었습니다. 걸음걸이도 흔들림 없이 탄탄해졌습니다. 삶의 질을 충실히 회복시켜 주신 원장님께 깊은 감사를 전합니다.",
            "hasTreatment": false,
            "treatmentType": null,
            "isCustom": false,
            "isCanonical": true
          },
          {
            ...
            "title": "시험장이나 긴장 상황만 되면 배가 부글거리고 화장실로 달려가던 과민대장, 호전되어 취업 성공했습니다",
          ...
          },
          {
            ...
            "content": "매일 아침 눈을 뜨자마자 뒷목이 뻣뻣하고 관자놀이를 밴드로 꽉 조이는 듯한 두통에 타이레놀과 이지엔을 한 움큼씩 먹으며 버텼습니다. 위장까지 상해 진통제 부작용이 심각해졌지만 약 없이는 하루도 버틸 수 없었습니다.\n\n해아림한의원에서 교감신경 과긴장으로 인한 근막 혈관 수축성 두통이라는 정확한 진단을 받고 치료에 들어갔습니다. 경추 자율신경절의 긴장이 풀리면서 머리를 옥죄던 묵직한 통증이 거짓말처럼 흩어졌습니다. 현재 진통제를 완전히 끊은 지 1년이 넘었지만 재발 위험을 낮추고 안정적으로 유지되었습니다. 머리가 맑아지니 매일매일 출근길이 가볍고 행복합니다.",
            "hasTreatment": false,
            "treatmentType": null,
            "isCustom": false,
            "isCanonical": true
          },
          {
            ...
            "content": "3년 넘게 잠자리에 누워도 심장이 쿵쾅거려 잠들기까지 2시간 이상 걸리고, 겨우 잠들어도 1~2시간 간격으로 깨어났습니다. 수면유도제에 의존했으나 아침마다 머리가 멍하고 기억력이 떨어져 고통스러웠습니다. 해아림한의원에서 뇌파와 심박변이도 검사 후 밤사이 교감신경이 가라앉지 않는 자율신경 실조를 확인했습니다. 야간 뇌간의 열을 식히고 멜라토닌 분비를 돕는 산조인 안신 탕약과 CST 치료를 시작한 지 2주 만에 6시간 연속 꿀잠을 잤고, 수면제 없이도 상쾌하게 아침을 맞이하고 있습니다.",
            "author": "40대 교사 조OO 님",
            "date": "2022.04.17",
            "views": 2310,
            "image": "/images/reviews/review_2.jpg"
          },
          {
            ...
            "content": "따뜻한 물로 샤워하고 나오거나 소파에서 일어설 때마다 눈앞이 캄캄해지고 식은땀이 나며 주저앉아야 했습니다. 체중도 적고 혈압도 낮아 체질 탓인 줄로만 알았는데, 갈수록 빈도가 잦아져 혼자 집에 있는 것조차 두려웠습니다.\n\n해아림의 정밀 자율신경 검사를 통해 혈관 운동 반사 기능이 지연되어 있다는 원인을 파악했습니다. 몸의 중심 에너지를 끌어올리고 혈관 탄력을 높여주는 체계적인 치료를 받으며 한 달 만에 기립 시 어지럼증이 80% 이상 개선되었습니다. 지금은 샤워 후에도 머리가 맑고, 지하철을 서서 타고 다녀도 어지럽지 않습니다. 든든하게 치료해 주셔서 참 고맙습니다.",
            "hasTreatment": false,
            "treatmentType": null,
            "isCustom": false,
            "isCanonical": true
          ...
          },
          {
            ...
            "content": "의자에서 일어나거나 아침에 일어날 때마다 눈앞이 새하얘지며 핑 돌아 벽을 짚고 주저앉곤 했습니다. 빈혈인 줄 알고 철분제를 오래 복용했으나 호전이 없었습니다. 해아림에서 압수용체 반사 지연과 하체 혈관 수축력 저하로 인한 전형적인 기립성 자율신경 조절 장애라는 설명을 들었습니다. 혈류를 심장과 뇌로 밀어 올려주는 보중익기탕 가감방과 골반-경추 밸런스 추나를 치료받은 지 한 달 만에 기립 시 아찔함이 씻은 듯이 사라져 활기차게 캠퍼스 생활을 하고 있습니다.",
          ...
          },
          {
            ...
            "views": 2124,
            "image": "/images/reviews/review_2.jpg",
            "title": "온몸을 몽둥이로 맞은 듯 쑤시던 전신 통증, 자율신경 회복으로 가뿐해졌습니다",
          ...
          },
          {
            ...
            "content": "긴장되는 상황이나 낯선 사람과 만날 때면 손과 겨드랑이에서 땀이 뚝뚝 떨어져 악수조차 나눌 수 없었습니다. 흉부 교감신경 차단술은 보상성 다한증 부작용이 두려워 엄두를 내지 못했습니다. 해아림에서 체온과 땀샘 분비를 독점 통제하는 교감신경 과민 반응을 안정시키는 치료를 받았습니다. 땀구멍의 개폐 조절력을 길러주는 옥병풍산 계열의 한약과 자율신경 이완 침치료 덕분에 발표나 회의 시에도 땀이 쏟아지지 않고 침착하게 프레젠테이션을 해내고 있습니다.",
          ...
          },
          {
            ...
            "content": "식사만 하면 아랫배가 풍선처럼 부풀어 오르고 가스가 차서 바지 단추를 풀지 않으면 숨을 쉴 수 없었습니다. 방귀와 트림이 잦아 연구실에서 사람들과 함께 일하는 것이 너무나 곤혹스러웠습니다. 유산균이나 소화제는 아무런 소용이 없었습니다.\n\n해아림에서 자율신경계 실조로 위장 연동운동 신호가 꼬여 있다는 설명을 듣고 치료를 시작했습니다. 굳어 있던 복부 긴장이 완화되면서 더부룩함과 복부 팽만이 점차 가라앉았습니다. 지금은 식후에도 배가 편안하고 가스 참도 거의 없어 연구 업무에 전념하고 있습니다. 제 건강을 되찾아주신 해아림에 깊이 감사드립니다.",
            "hasTreatment": false,
            "treatmentType": null,
            "isCustom": false,
            "isCanonical": true
          ...
          },
          {
            ...
            "content": "고객 상담 중 조금만 긴장하거나 온도 변화가 있으면 얼굴과 목덜미가 불타는 고구마처럼 붉어지고 열감이 뻗쳤습니다. 피부과 레이저 시술도 받아보았지만 열감 자체를 잡을 수 없어 심리적 위축이 극에 달했습니다. 거울을 볼 때마다 눈물이 났습니다.\n\n해아림한의원에서 심장에 뭉친 울화와 자율신경계 혈관 운동 실조를 다스리는 치료를 받았습니다. 상체로 몰리던 비정상적인 열기가 아래로 가라앉으면서, 얼굴이 화끈거리며 붉어지던 현상이 눈에 띄게 완화되었습니다. 이제는 대인관계에서도 당당하게 얼굴을 마주하고 환하게 웃을 수 있어 큰 자신감을 되찾았습니다.",
            "hasTreatment": false,
            "treatmentType": null,
            "isCustom": false,
            "isCanonical": true
          ...
          },
          {
            ...
            "content": "아침에 눈을 뜨는 것조차 고역이었고, 청소기 한번 돌리고 나면 탈진해서 반나절을 누워 있어야 했습니다. 비타민 수액을 맞아도 효과는 그때뿐이었고, 온몸의 에너지가 바닥나 우울증까지 찾아왔습니다. 조금만 신경 써도 식은땀이 나고 기력이 떨어져 사람 만나는 것조차 피하게 되었습니다.\n\n해아림한의원에서 자율신경 활력도 검사를 받고 부교감과 교감이 모두 바닥인 '번아웃 신경 쇠약' 상태임을 확인했습니다. 원장님의 세심한 지도와 치료를 3개월간 성실하게 따르면서, 몸 밑바닥에서부터 은은하게 생체 에너지가 차오르는 것을 느꼈습니다. 지금은 집안일은 물론 취미 생활로 꽃꽂이와 요가까지 거뜬히 소화합니다. 맑고 활기찬 제 모습을 되찾아주셔서 감사합니다.",
            "hasTreatment": false,
            "treatmentType": null,
            "isCustom": false,
            "isCanonical": true
          },
          {
            ...
            "views": 1820,
            "image": "/images/reviews/review_1.jpg",
            "title": "엘리베이터나 마트 진열대만 보면 어지럽던 전정신경 증상 호전 후기",
            "content": "대형마트의 빽빽한 진열대를 보거나 엘리베이터를 타면 뇌가 흔들리고 균형을 잡지 못해 물건을 놓치기 일쑤였습니다. 이석증 치료를 여러 번 받았지만 미세한 잔여 어지럼증과 머릿속 멍함은 사라지지 않아 일상생활이 지옥 같았습니다. 운전은커녕 혼자 길을 걷는 것조차 불안해 늘 누군가의 팔을 붙잡고 다녀야 했습니다.\n\n해아림한의원 자율신경 클리닉에서 전정 기능과 연계된 뇌 혈류 순환 치료를 체계적으로 받았습니다. 흔들리던 중심 감각이 서서히 단단해지더니 두 달 만에 마트나 백화점에 가도 아무렇지 않게 쇼핑을 즐길 수 있게 되었습니다. 어지럼증 공포에서 벗어나게 해 주셔서 감사드립니다.",
            "hasTreatment": false,
            "treatmentType": null,
            "isCustom": false,
            "isCanonical": true
          },
          {
            ...
            "content": "30분 간격으로 소변이 마렵고 조금만 참아도 아랫배가 찢어질 듯 아파 지하철 타는 것조차 공포였습니다. 비뇨기과 방광염 검사는 깨끗한데 방광근육 과민제는 입만 바짝 마를 뿐 효과가 없었습니다. 해아림에서 골반강 자율신경 부교감신경 실조를 치료하는 맞춤 한약과 하초 온열 침뜸 치료를 받았습니다. 골반 긴장이 풀리고 방광 괄약근이 부드러워지면서 배뇨 간격이 3~4시간으로 정상화되었고, 밤에도 깨지 않고 편안하게 수면을 취합니다.",
            "author": "60대 주부 전OO 님",
            "date": "2018.06.30",
            "views": 3020,
            "image": "/images/reviews/review_1.jpg"
          ...
          },
          {
            ...
            "views": 1673,
            "image": "/images/reviews/review_3.jpg",
            "title": "터널이나 고속도로 운전 중 숨이 턱 막히던 공황 증상, 안정적으로 회복 판정 받았습니다",
            "content": "고속도로 터널을 지날 때 갑자기 가슴이 터질 듯 뛰고 손발이 마비되며 차를 갓길에 세워야 했던 공황발작이 있었습니다. 그 뒤로 다리 위나 터널, 고속도로는 쳐다보지도 못하고 국도로만 돌아다녀 직업을 잃을 뻔했습니다. 가장으로서 막막함에 잠을 이룰 수 없었습니다.\n\n해아림한의원에서 뇌 편도체의 과민 경보를 끄고 자율신경 안정을 찾아주는 집중 치료를 받았습니다. 치료 과정에서 점차 마음의 안정과 신체 통제력을 회복하였고, 원장님의 격려 속에 터널 운전 훈련을 거쳐 마침내 고속도로 장거리 운전도 아무런 불안 없이 완주했습니다. 제 직업과 가정을 지켜주신 은인입니다.",
            "hasTreatment": false,
            "treatmentType": null,
            "isCustom": false,
            "isCanonical": true
          },
          {
            ...
            "content": "어깨, 등, 허리, 골반 할 것 없이 온몸 구석구석이 쑤시고 아파 정형외과, 마취통증의학과, 류마티스내과를 수없이 전전했습니다. 류마티스 인자나 염증 수치는 다 정상인데 본인은 숨도 못 쉴 만큼 아팠습니다. 섬유근육통은 통증을 전달하고 억제하는 중추 신경계 신경전달물질의 교란과 자율신경 실조가 주요 원인이라는 해아림의 설명을 듣고 희망을 품었습니다. 굳어있던 심부 척추 신경근을 이완하는 침 치료와 기혈 순환 탕약을 3개월간 복용했습니다. 찌르는 듯한 전신 유주성 통증이 80% 이상 줄어들었고, 이제는 손자들과 함께 공원 산책을 다닐 정도로 거동이 편안해졌습니다.",
          ...
          },
          {
            ...
            "title": "온몸에 쥐가 나듯 찌릿거리고 감각이 둔해져 뇌질환 의심했던 말초 신경 이상, 자율신경 조절로 회복",
          ...
          },
          {
            ...
            "content": "밥을 삼킬 때마다 식도 중간에 음식이 꽉 걸려 가슴을 쥐어짜는 듯한 통증이 발생했습니다. 식도 내시경과 조영술에서도 연하 기능에는 이상이 없다고 하는데, 식사 시간이 두려워 죽만 먹다 보니 기력이 쇠약해졌습니다.\n\n해아림한의원에 내원하여 스트레스로 인한 식도 괄약근 경련 및 자율신경 실조 진단을 받았습니다. 위장 신경을 정상화하는 맞춤 한약과 자율신경 밸런스를 돕는 뇌파 바이오피드백 훈련, 침 치료를 2개월간 성실히 받았습니다. 식도가 부드럽게 이완되면서 음식이 막힘없이 술술 넘어가기 시작했고, 지금은 일반 밥과 고기도 맛있게 씹어 삼킵니다. 진심으로 감사드립니다.",
            "hasTreatment": true,
          ...
          },
          {
            ...
            "content": "10시간을 자도 피로가 전혀 풀리지 않고 온몸이 물에 젖은 솜처럼 무거워 일상생활 자체가 불가능했습니다. 각종 간장약과 영양제를 쏟아부어도 기력이 돌아오지 않았습니다. 해아림에서 HPA 축(시상하부-뇌하수체-부신)의 기능적 탈진과 자율신경 실조 상태를 진단받고, 진액을 보충하고 부신 기능을 소생시키는 맞춤 공진단 및 보기보양 탕약을 처방받았습니다. 복용 3주 만에 몸이 가뿐해지며 활력이 솟았고, 이제는 주말마다 등산을 다닐 만큼 원기를 회복했습니다.",
          ...
          },
          {
            ...
            "views": 1525,
            "image": "/images/reviews/review_5.jpg",
            "title": "한여름에도 손발이 시려 수면양말을 신던 극심한 수족냉증 안정 회복",
            "content": "한여름 무더위에도 손가락과 발가락 끝이 시리고 저려 에어컨이 나오는 곳에는 10분도 앉아 있지 못했습니다. 혈액순환 개선제를 아무리 먹어도 효과가 없고 레이노드 증후군 의심까지 받아 고통스러웠습니다. 손발이 너무 차가워 잠들 때도 발끝에 온열기를 틀어야 했습니다.\n\n해아림한의원에서 자율신경계 말초 혈관 수축 반사 장애를 교정하는 치료를 받았습니다. 차갑게 얼어붙어 있던 손발 말초 혈관이 서서히 열리며 따뜻한 혈액이 돌기 시작했고, 손발 저림과 시린 감각이 씻은 듯 사라졌습니다. 이제는 여름에도 편안하게 외출하고 에어컨 바람도 두렵지 않습니다. 삶의 큰 짐을 덜어주셨습니다.",
            "hasTreatment": false,
            "treatmentType": null,
            "isCustom": false,
            "isCanonical": true
          },
          {
            ...
            "content": "물을 하루 2리터 이상 마셔도 입안이 모래사막처럼 마르고 혀가 불타는 듯 쓰려 음식을 먹기조차 힘들었습니다. 치과와 이비인후과에서는 쇼그렌 증후군은 아니라며 가글액만 처방해 주어 절망했습니다. 해아림한의원에서 침샘을 지배하는 자율신경 기능 마비와 심장·위장의 화열(火熱)을 다스리는 생혈윤조 탕약 처방을 받았습니다. 한약 복용 4주 만에 침샘에서 자연스러운 침이 고이기 시작했고, 혀의 작열감이 말끔히 사라져 좋아하는 매콤한 음식도 맛있게 먹고 있습니다.",
            "author": "60대 주부 서OO 님",
            "date": "2014.10.27",
            "views": 3410,
            "image": "/images/reviews/review_4.jpg"
          },
          {
            ...
            "content": "수업 시간 도중이나 영화관에 갈 때마다 소변이 마려워 1시간에 서너 번씩 화장실을 들락거렸습니다. 비뇨기과 검사상 방광염이나 전립선 이상은 전혀 없었는데, 소변을 보고 나와도 개운하지 않고 방광이 조여왔습니다. 장거리 여행이나 버스는 엄두도 못 냈습니다.\n\n해아림한의원에서 방광 평활근을 지배하는 골반 자율신경총의 과긴장을 안정시키는 치료를 받았습니다. 초조했던 마음이 차분해지면서 방광에 소변이 정상적으로 차도 불안하지 않게 되었습니다. 지금은 3~4시간 동안 화장실 걱정 없이 편안하게 수업을 진행하고 여행도 즐깁니다. 깊은 감사를 드립니다.",
            "hasTreatment": false,
            "treatmentType": null,
            "isCustom": false,
            "isCanonical": true
          },
          {
            ...
            "views": 1412,
            "image": "/images/reviews/review_1.jpg",
            "title": "머릿속이 흔들리고 눈이 빠질 듯 아프던 안구 통증과 두통 안정 회복",
            "content": "모니터를 30분만 봐도 안구가 빠질 듯 아프고 관자놀이가 쑤시며 어지럼증이 동반되었습니다. 안과 검사는 정상이어서 직업병이라 생각하고 체념하며 살았지만 퇴사 위기에 몰렸습니다. 눈을 뜨고 있는 것 자체가 고통이었습니다.\n\n해아림한의원에서 삼차신경과 경추 자율신경의 긴장 연계성을 진단받고 맞춤 치료를 진행했습니다. 눈 뒤쪽을 짓누르던 팽팽한 압력감이 서서히 빠져나가면서 눈 피로와 두통이 극적으로 호전되었습니다. 장시간 코딩 작업을 해도 눈이 맑고 집중력이 유지되어 업무 성과도 크게 올랐습니다. 새 눈과 맑은 머리를 선물해 주셔서 감사합니다.",
            "hasTreatment": false,
            "treatmentType": null,
            "isCustom": false,
            "isCanonical": true
          },
          {
            ...
            "category": "만성 어지럼증 & 불면",
            "title": "엘리베이터도 못 탈 만큼 심각했던 회전성 어지럼증과 3년 불면증, 한방 치료로 안정적으로 회복했습니다",
          ...
          },
          {
            ...
            "content": "사업 스트레스로 가슴이 조여오고 숨이 가빠져 심근경색인 줄 알고 대학병원 응급실을 세 번이나 실려갔습니다. 심혈관 조영술까지 받았지만 심장은 깨끗하다는 결과에 답답하고 불안했습니다. 언제 또 가슴 통증이 올지 몰라 매 순간 살얼음판을 걷는 기분이었습니다.\n\n지인의 강력한 추천으로 해아림한의원을 찾았고, 흉곽 자율신경절의 과흥분을 완화하는 체계적인 치료를 3개월 동안 꾸준히 받았습니다. 거짓말처럼 가슴을 쥐어짜던 압박감이 풀리고 숨길이 활짝 열렸습니다. 심장이 안정되니 사업에도 큰 활력이 붙었습니다. 건강을 되찾아주신 해아림에 깊이 감사드립니다.",
            "hasTreatment": false,
            "treatmentType": null,
            "isCustom": false,
            "isCanonical": true
          },
          {
            ...
            "views": 1297,
            "image": "/images/reviews/review_3.jpg",
            "title": "온몸의 신경이 곤두서 미칠 것 같던 12년 전 자율신경실조증, 해아림에서 안정 회복",
            "content": "작은 소리에도 깜짝 놀라고, 심장이 수시로 뛰며 손발이 떨리고 머리가 멍해지는 온갖 신체 증상이 한꺼번에 덮쳤습니다. 병원 쇼핑을 2년 넘게 다녔지만 원인을 모른다는 말에 절망의 끝에 서 있었습니다.\n\n마지막 희망으로 찾은 해아림한의원에서 원장님은 제 호소에 귀 기울여 주셨고 자율신경실조증이라는 명쾌한 진단과 함께 따뜻하게 손을 잡아주셨습니다. 원장님을 믿고 4개월간 꾸준히 치료를 받은 결과, 곤두서 있던 전신 신경계가 평온을 되찾았고 건강한 일상으로 완전히 복귀했습니다. 10년이 훌쩍 지난 지금까지도 건강하게 잘 지내고 있어 감사한 마음에 글을 남깁니다.",
            "hasTreatment": false,
            "treatmentType": null,
            "isCustom": false,
            "isCanonical": true
          },
          {
            ...
            "category": "전신신체화 & 난치성 자율신경",
            "title": "10년 넘게 원인 모를 전신 통증과 공포감으로 고통받았는데, 해아림 자율신경 클리닉을 만나 제2의 인생을 살고 있습니다",
            "content": "가슴 두근거림, 호흡곤란, 어지럼증, 위경련, 불면증이 10년 동안 끊이지 않고 돌아가며 찾아와 전국 유명 대학병원을 다 돌았습니다. 검사 결과는 늘 신경성이라는 말뿐이었고 가족들조차 꾀병이라 오해해 삶의 의욕을 잃었었습니다. 마지막 지푸라기라도 잡는 심정으로 해아림에 내원하여 자율신경실조증이라는 정확한 원인을 알게 되었을 때 눈물이 쏟아졌습니다. 6개월간 원장님의 맞춤 한약 처방과 두개천골요법, 침구 치료를 꾸준히 받으면서 10년을 괴롭히던 복합 증상들이 하나씩 소멸되었고, 현재는 온전하고 건강한 삶을 누리고 있습니다.",
          ...
          },
          {
            ...
            "content": "스트레스만 받으면 위장이 쥐어짜듯 뒤틀리며 극심한 경련이 발생해 119 구급차를 탄 것만 10번이 넘습니다. 대학병원 위장관 조영술과 내시경 검사를 매년 반복해도 \"신경성 위경련이니 마음을 편히 가지라\"는 허탈한 답변뿐이었습니다. 지인의 강력한 추천으로 해아림한의원을 찾아 자율신경과 위장관 연동 신경망을 안정시키는 맞춤 치료를 시작했습니다. 복부 담적을 삭히고 간위불화(肝胃不和)를 해소하는 탕약을 복용하자 2주 만에 복부 팽만과 위경련 조짐이 사라졌습니다. 3달 안정 회복 프로그램을 마친 후 지난 10년 동안 재발 위험을 낮추고 안정적으로 유지되었으며, 지금도 감사한 마음으로 건강하게 사업을 운영하고 있습니다.",
        ...
        title: '자율신경실조증이 있는 사람이 가급적 하면 안 되는 행동 3가지',
        content: '교감신경을 극도로 자극하는 카페인·자극적 음식, 불규칙한 야간 수면 패턴, 과도한 고강도 운동 등 자율신경실조증 환자가 일상에서 주의가 권장되는 핵심 행동 3가지.'
        },
        {
        id: 'yt-2',
        category: '영상',
        ...
        content: '공황장애와 불안장애의 밑바탕에 깔려있는 교감신경 과흥분 메커니즘과 자율신경 안정을 통한 체계적 조절 치유의 열쇠.'
        },
        {
        id: 'yt-6',
        category: '영상',
        ...
        var defaultColumnsData = [
                  ...
                  },
                  {
                            ...
                            "colIndex": 14,
                            "category": "칼럼",
                            "title": "안정 회복까지 얼마나 걸릴까? 진료실에서 설명해 드리는 자율신경실조증 3단계 회복 로드맵과 재발율을 낮추는 건강한 몸",
                            "summary": "자율신경실조증은 과연 안정 회복가 가능한 질환인가? 급성 신체화 증상 안정부터 신경계 가소성 재건, 자가 항상성 공고화에 이르는 한방신경정신과 3단계 치료 로드맵을 투명하게 공개합니다.",
                            "content": "\"원장님, 이 지긋지긋한 어지럼증, 가슴 두근거림, 불면증, 소화장애에서 정말 벗어날 수 있을까요? 치료를 받으면 언제쯤 좋아지고, 안정 회복된 후에도 재발율을 낮추고 건강한 일상을 유지할 수 있을까요?\" 진료실에서 환자분들과 초진 상담을 마칠 때마다 가장 많이 마주하는 간절하고도 절실한 질문입니다. 수개월에서 수년 동안 원인 모를 고통에 시달리며 병원 쇼핑을 거듭해 온 분들일수록, 자신의 몸이 영원히 회복되지 못할지도 모른다는 깊은 절망감에 짓눌려 계시기 때문입니다.\n\n임상 현장에서 수많은 자율신경실조증 환자분들을 치료하며 얻은 확고한 결론부터 말씀드리자면, 자율신경실조증은 호전이 어려운 불치의 질환이 아니며, 체계적이고 과학적인 한방 신경계 복원 치료를 통해 점차 건강한 본래의 일상으로 복귀할 수 있는 기능성 질환입니다. 다만 고장 난 기계 부품을 갈아 끼우듯 단 며칠 만에 끝나는 치료가 아니라, 뒤틀린 신경망의 균형을 단계별로 재건해 나가는 명확한 3단계 치료 로드맵을 충실히 밟아나가야 합니다.\n\n**제1단계: 급성 신체화 증상 진정 및 뇌신경 안정기 (치료 1~4주)**\n이 시기의 최우선 목표는 환자를 공포로 몰아넣는 급박한 신체화 증상의 불길을 끄는 것입니다. 발작적인 가슴 두근거림, 호흡곤란, 어지럼증, 급격한 상열감과 불면증을 다스리기 위해 뇌간의 과열된 흥분을 가라앉히는 청열안신(淸熱安神) 한약과 자율신경 약침을 집중 투여합니다. 이 단계가 지나면 환자분들은 \"죽을 것 같던 발작 빈도가 눈에 띄게 줄어들고 비로소 살 것 같다\"는 안도감을 느끼게 됩니다.\n\n**제2단계: 장부 불균형 교정 및 신경계 가소성 재건기 (치료 2~3개월)**\n급한 불이 꺼진 후에는 신경계가 오작동하게 된 인체 내부의 주요 원인을 뿌리 뽑아야 합니다. 뇌-장-신경 축을 회복시키는 담적 치료, 부신 피로를 회복시켜 HPA 축을 정상화하는 보신(補腎) 치료, 그리고 척추와 두개골의 긴장을 풀어 미주신경 통로를 확보하는 두개천골요법(CST)과 추나요법이 본격화됩니다. 자율신경계가 스스로 자극을 흡수하고 완충하는 신경 가소성(Neuroplasticity)이 살아나면서 만성 피로와 소화불량이 드라마틱하게 호전됩니다.\n\n**제3단계: 생체 항상성 완성 및 재발 방지 공고기 (치료 4~6개월)**\n마지막 단계는 치료를 종결한 후에도 일상의 스트레스나 과로에 쉽게 흔들리지 않는 단단한 '항상성 옹벽'을 구축하는 시기입니다. 기혈을 보양하고 면역력을 강화하는 맞춤 한약과 함께, 횡격막 복식호흡 훈련, 수면 리듬 설계, 자율신경 회복 식습관을 완전히 체질화합니다.\n\n신경계 치료는 직선으로만 나아가지 않고 컨디션에 따라 약간의 기복을 보이며 완만한 나선형 상승곡선을 그립니다. 조급한 마음을 내려놓고 의료진을 믿으며 한 걸음씩 로드맵을 따라갈 때, 어두운 터널을 지나 눈부시게 건강하고 활기찬 일상이 점차 안정적으로 되찾으실 수 있을 것입니다.\n\n[자율신경실조증 검사 알아보기](https://healim-autonomic.com/autonomic-diagnosis)\n\n[자율신경실조증 치료방법 알아보기](https://healim-autonomic.com/autonomic-treatment)\n\n[전국 지점 안내](https://www.healim.com)",
                            "author": "해아림한의원",
                            "date": "2026.08.25",
        ...
        function renderColumnsList() {
          ...
          pageItems.forEach(function(item, idx) {
            ...
            var mobileAdminBtns = isSuperAdmin ? (
              ...
              '<button type="button" class="px-1.5 py-0.5 text-xs text-[#1c6e78] bg-[#eaf3f4] rounded border border-[#badfe3]" onclick="event.stopPropagation(); openEditModal(\'columns\', \'' + safeColId + '\')">수정</button>' +
              '<button type="button" class="px-1.5 py-0.5 text-xs text-red-600 bg-red-50 rounded border border-red-200" onclick="event.stopPropagation(); handleDeletePostDirect(\'columns\', \'' + safeColId + '\')">삭제</button>' +
              '</span>'
            ) : '';
