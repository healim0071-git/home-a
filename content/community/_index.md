      ...
      text: |
        ...
        var defaultReviewsData = [
          ...
          },
          {
            ...
            "content": "자고 일어나도 뇌에 기름이 낀 것처럼 멍하고 집중이 전혀 되지 않았습니다. 학생들의 질문에 바로 대답이 나오지 않고 단어가 떠오르지 않아 수업 진행이 불가능할 정도였습니다. 번아웃과 만성 피로로 휴직까지 결심하고 절망적인 나날을 보냈습니다.\n\n해아림한의원에서 뇌파 검사와 자율신경 검사를 진행한 뒤 뇌간 순환을 돕는 맞춤 한약과 경추-두개골 긴장을 부드럽게 이완시키는 두개천골요법(CST)을 꾸준히 받았습니다. 치료 4주 차부터 머리를 무겁게 짓누르던 두중감이 걷히더니 시야가 선명해졌습니다. 3개월 후에는 복합적인 사고와 기억력이 예전 상태로 완벽히 돌아와 무사히 교단으로 복직할 수 있었습니다. 맑은 머리로 아이들을 마주하는 매일이 행복합니다.",
            "hasTreatment": true,
          ...
          },
          {
            ...
            "content": "오른쪽 귀에서 밤낮없이 삐- 하는 고주파 이명이 들리고, 걸을 때마다 스펀지 위나 구름 위를 걷는 것처럼 휘청거려 넘어질 뻔한 적이 한두 번이 아니었습니다. 이비인후과에서는 평생 적응하며 살아야 한다고 해서 눈앞이 캄캄했습니다.\n\n지푸라기라도 잡는 심정으로 해아림한의원에 내원하여 자율신경계 순환 치료를 받았습니다. 서서히 귀 주변의 미세 혈류가 개선되고 뇌압이 안정되면서, 귓속을 울리던 날카로운 소리가 희미해지더니 3개월 만에 일상에서 거의 의식하지 못할 정도로 호전되었습니다. 걸음걸이도 흔들림 없이 탄탄해졌습니다. 삶의 질을 완벽히 회복시켜 주신 원장님께 깊은 감사를 전합니다.",
            "hasTreatment": false,
            "treatmentType": null,
            "isCustom": false,
            "isCanonical": true
          ...
          },
          {
            ...
            "views": 1297,
            "image": "/images/reviews/review_3.jpg",
            "title": "온몸의 신경이 곤두서 미칠 것 같던 12년 전 자율신경실조증, 해아림에서 완치",
