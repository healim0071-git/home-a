...
(function() {
  ...
  // 1. 지양 단어 치환 (근원치료/근본치료, 완치, 전문병원, 전문/특화/첨단, 완벽해결, 부작용 없다 등)
  // 2. 타 병원 비교 우위 배제
  // 3. '재발안된다' 지양 -> '재발율이 낮아진다'
